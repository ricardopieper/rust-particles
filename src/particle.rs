...
impl Particle {
    ...
    pub fn is_connected_with(&self, other: &Particle, radius: f64) -> bool {
        Particle::distance_between(self, other) <= radius
    }

    fn distance_between(particle1: &Particle, particle2: &Particle) -> f64 {
